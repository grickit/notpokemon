// ----- CLASS: callback {
  function callback() {
    ...
    this.subscribe = function(callback_object,callback_function,callback_arguments) {
      this.subscribers.push([callback_object,callback_function,callback_arguments]);
    }
